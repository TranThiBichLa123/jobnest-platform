...
CREATE TABLE job_views (
    ...
    CONSTRAINT fk_job_view_job
        FOREIGN KEY (job_id)
        REFERENCES jobs(id),

    CONSTRAINT fk_job_view_viewer
...
CREATE TABLE notification_preferences (
    ...
    CONSTRAINT fk_notification_pref_account
        FOREIGN KEY (account_id)
        REFERENCES accounts(id)
);
...
CREATE TABLE conversations (
    ...
    CONSTRAINT fk_conversation_participant_one
        FOREIGN KEY (participant_one_id)
        REFERENCES accounts(id),

    CONSTRAINT fk_conversation_participant_two
        FOREIGN KEY (participant_two_id)
        REFERENCES accounts(id),

    CONSTRAINT fk_conversation_job
        FOREIGN KEY (job_id)
        REFERENCES jobs(id)
);
...
CREATE TABLE payments (
    ...
    CONSTRAINT fk_payment_service_package
...
CREATE INDEX idx_email_verification_account_id
