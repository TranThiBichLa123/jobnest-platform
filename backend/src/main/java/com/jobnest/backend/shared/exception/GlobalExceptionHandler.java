...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMissingPart(MissingServletRequestPartException ex, HttpServletRequest request) {
        return buildResponse(HttpStatus.BAD_REQUEST, "Missing required multipart field: " + ex.getRequestPartName(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex, HttpServletRequest request) {
        ...
        return buildResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Internal server error. Please check backend logs with requestId.", request);
    }

    private String formatFieldError(FieldError error) {
        if (error == null) return "Validation error";
