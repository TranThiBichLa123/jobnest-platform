        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4 mb-6">
                <AdminMetricCard
                    ...
                    iconClassName="bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-300"
                    sparklineClassName="text-blue-600 dark:text-blue-300"
                    sparkline={[1, 2.2, 2.1, 3.4, 4.2, 3.7, users.length]}
                />
                ...
                <AdminMetricCard
                    ...
                    sparkline={[1, 1, 1.8, 1.2, 2, 2, stats.employers]}
                />
                ...
                <AdminMetricCard
                    ...
                    sparkline={[1, 1.5, 1.1, 2.2, 1.7, 3, companies.length]}
                />
                ...
                <AdminMetricCard
                    ...
                    trend="+18.7%"
                    trendColor="text-emerald-600"
                    iconClassName="bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-300"
                    sparklineClassName="text-indigo-600 dark:text-indigo-300"
                    sparkline={[1, 1, 1.5, 1.5, 1, 2.4, stats.activeJobs]}
                />
                ...
                <AdminMetricCard
                    ...
                    sparkline={[1, 1.7, 2.4, 1.8, 3.2, 2.5, applications.length]}
                />
            </div>
