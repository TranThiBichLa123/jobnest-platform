        ...
        <div className="card p-3 mt-3 group" key={job.id}>
          <div className="flex-align-center gap-x-2">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-sm">
                {job?.company_name} <span className="text-muted">{job?.location}</span>
              </h1>
            </div>
          ...
          <div className="mt-3 flex-center-between">
            ...
            <span className="text-sm">
              <span className="text-primary">New</span> <span className="text-muted">7d</span>
            </span>
          </div>
        </div>
      ))}
